...
module.exports = "<h1>Users</h1>\n\n<p> Información en formato JSON extraída por medio de HttpClient de la siguiente API: <a href=\"https://jsonplaceholder.typicode.com/users\">https://jsonplaceholder.typicode.com/users</a></p>\n\n<ul [@listStagger]=\"users$\">\n  <li *ngFor=\"let user of users$\">\n    <a routerLink=\"/details/{{user.id}}\">{{ user.name }}</a>\n\n    <ul>\n      <li>{{ user.email }}</li>\n      <li><a href=\"http://{{ user.website }}\">{{ user.website }}</a></li>\n    </ul>\n  </li>\n</ul>\n"
...
module.exports = __webpack_require__(/*! C:\Users\EMILY\Documents\cosas_de_werner\ng6\src\main.ts */"./src/main.ts");
